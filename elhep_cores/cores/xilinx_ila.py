...
# TODO: Use mark_debug_clock attirbute instead/additionally to ILAProbeAsync

class ILAProbeAsync(Module):
...
def xilinx_ila_args(parser):
    parser.add_argument("--with-ila", action="store_true", help="Add Xilinx ILA to design")
    parser.add_argument("--ila-depth", action="store", default=1024, type=int, help="Define ILA depth, defaults to 1024")


def insert_ila_script():
    # This script was written by J. McCluskey and published at Xilinx Forums:
    # https://forums.xilinx.com/t5/Vivado-TCL-Community/Vivado-TCL-script-to-insert-ILA/td-p/421619
    return """
######################################################################
